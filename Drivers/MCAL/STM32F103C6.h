...
#define RCC_TIMER1_Enable()  (RCC->APB2ENR |= 1<<11)
#define RCC_TIMER2_Enable()  (RCC->APB1ENR |= 1<<0)
#define RCC_TIMER3_Enable()  (RCC->APB1ENR |= 1<<1)
#define RCC_TIMER4_Enable()  (RCC->APB1ENR |= 1<<2)

#define RCC_ADC1_Enable()  (RCC->RCC_APB2ENR |= 1<<9)
#define RCC_ADC2_Enable()  (RCC->RCC_APB2ENR |= 1<<10)
#define RCC_ADC1_DESABLE()  (RCC->RCC_APB2RSTR |= 1<<9)
#define RCC_ADC2_DESABLE()  (RCC->RCC_APB2RSTR |= 1<<10)
